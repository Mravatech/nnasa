...
class AnotherCompanyProfileHolder(itemView: View, item: ProfileModel) : BaseProfileHolder(itemView) {
...
//        }
    ...
    companion object {
        fun newInstance(parent: ViewGroup, profileModel: ProfileModel): AnotherCompanyProfileHolder {
            val view = LayoutInflater.from(parent.context).inflate(R.layout.item_header_another_profile_company_view, parent, false)
            return AnotherCompanyProfileHolder(view, profileModel)
        }
    }
}