...
class AnotherPersonalProfileHolder(itemView: View, item: ProfileModel) : BaseProfileHolder(itemView) {
...
//        }
    ...
    companion object {
        fun newInstance(parent: ViewGroup, profileModel: ProfileModel): AnotherPersonalProfileHolder {
            val view = LayoutInflater.from(parent.context).inflate(R.layout.item_header_another_profile_personal_view, parent, false)
            return AnotherPersonalProfileHolder(view, profileModel)
        }
    }
}