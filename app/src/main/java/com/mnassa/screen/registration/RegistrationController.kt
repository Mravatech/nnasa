        ...
        with(requireNotNull(view)) {
            when (vpRegistration.currentItem) {
                PAGE_PERSON_INFO -> if (validatePersonInfo()) viewModel.registerPerson(
                        ...
                        offers = "-L5o3gRz9DfDXkdTZ01B",//etPersonOffers.text.toString(),//todo remove hard code
                        interests = "-L59C0y19-aGFdDN8kNc")//etPersonInterests.text.toString())//todo remove hard code
