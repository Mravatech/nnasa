...
//////////////////////////////////////////// MAPPING ///////////////////////////////////////////////
private inline fun <reified T : Any> mapSingleValue(dataSnapshot: DataSnapshot?): T? {
...
private inline fun <reified T : Any> mapListOfValues(dataSnapshot: DataSnapshot?): List<T> {
...
internal inline fun <reified T : Any> getObservable(databaseReference: DatabaseReference, path: String): ReceiveChannel<List<T>> {
...
internal inline fun <reified T : Any> getObservable(databaseReference: DatabaseReference, path: String, id: String): ReceiveChannel<T?> {
...
private suspend inline fun <reified T : HasId> loadPortion(databaseReference: DatabaseReference, path: String, offset: String? = null, limit: Int = DEFAULT_LIMIT): List<T> {
